...
for i = 1:100
data_new(i,:) = interp1(t,y(:,i),(0:4:2000));
data_new_IgM(i,:) = interp1(t,y(:,i+100),(0:4:2000));
end
...
[tt, zz]=ode15s(@pathway_model_many_antibody_immune_res_new,[0 1],x0,[],para_2,para_new);

out_IgM(k) = 1e16-interp1(tt,zz(:,101),1);
end
...
[ttt, zzz]=ode15s(@pathway_model_many_antibody_immune_res_new,[0 1],x0,[],para_2,para_new);

out_IgG(k) = 1e16-interp1(ttt,zzz(:,101),1);
end
