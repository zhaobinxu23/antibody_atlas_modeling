function F=pathway_model_single_antibody_immune_res_new(t,y,para)

for i = 1: 5
    y(i) = max(0,y(i));
end

F(1,1) = para(11)+para(10)*y(3)-para(1)*y(1)*y(2)+para(3)*y(3)+para(6)*y(5)+para(8)*y(5)-para(7)*y(1)*y(4)-para(2)*y(1);
