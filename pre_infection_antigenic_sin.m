...
% virus = interp1(t,y(:,101),(0:1:100));

strong_antibody = interp1(t,y(:,51),200)+interp1(t,y(:,61),200)+interp1(t,y(:,62),200)+interp1(t,y(:,71),200)+interp1(t,y(:,72),200)+interp1(t,y(:,73),200)+interp1(t,y(:,81),200)+interp1(t,y(:,82),200)+interp1(t,y(:,83),200)+interp1(t,y(:,84),200)...
    +interp1(t,y(:,91),200)+interp1(t,y(:,92),200)+interp1(t,y(:,93),200)+interp1(t,y(:,94),200)+interp1(t,y(:,95),200);
% 
% plot((0:1:100),virus,'linewidth',2);
% hold on
% plot(t,y(:,101),'linewidth',2);
% hold on
...
for i = 1:100
data_new(i,:) = interp1(t,y(:,i),(0:1:200));
end

for i = 1:100
data_new_complex(i,:) = interp1(t,y(:,i+101),(0:1:200));
end

% plot((0:1:200),sum(data_new_complex),'linewidth',2);
% hold on
...
%     
%         for j = 1:101
%         data_k_off(mod(i-1,10)+1,j) = data_k_off(mod(i-1,10)+1,j) + data_new(i,j);
%         end
% end 
