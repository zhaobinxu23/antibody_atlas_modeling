...
% for i = 1:100
% data_new_complex(i,:) = interp1(t,y(:,i+101),(0:1:1000));
% end
...
for i = 1:10
    for j = 1:10
        x0(10*(i-1)+j) = prob_A(i)*prob_B(j)*total_B*(1-1e-8)+1e-8*data_new(10*(i-1)+j,1001);
    end
end
x0(101) = 1e2;%% virus
...
% 创建视频写入对象
writerObj = VideoWriter('extended_video_5.avi');
open(writerObj);
